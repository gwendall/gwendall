...
I make AI characters - the kind you care about, not the kind you give tasks to.

For the past 15 years, I've built games, avatars, cameras, and 3D worlds. I keep
coming back to the same question: how do you give digital things an identity of
their own?
...
- [**NakedPunks**](https://nakedpunks.app) - full-body pixel avatars with generative visuals and behaviors.
- [**PunkMap**](https://punkmap.vercel.app) - a private, token-gated directory showing where CryptoPunks holders live and what they do.
- [**Nexus.JS**](https://meeb.cam/lab/nexus) - a 2D/3D interaction system for browser-based editors and spatial tools.
- [**VibeWorld**](https://vibeworld.co) - a persistent multiplayer world engine for the web.
- [**SuperClaude**](https://github.com/gwendall/superclaude) - AI-assisted GitHub workflows for commits, changelogs, and code reviews.
- [**DOS.Chat**](https://doschat.vercel.app) - a sentient retro OS with an 80s sci-fi AI personality.
- [**VibeHouse**](https://vibeworld.co/arcade) - a 3D virtual arcade room for vibe-coded games.
...
- [**TurnMe.AI**](https://turnme.ai) - a social AI image generator.
...
- [**PunkMaker**](https://punkmaker.xyz) - a CryptoPunk remix and avatar generator.
- [**PUNK.CAM**](https://punk.cam) - a CryptoPunk identity camera.
- [**Hotline**](https://hotline.fm) - a character-driven AI chat platform.
- [**Bring The Bird Back**](https://chromewebstore.google.com/detail/bring-the-bird-back/khmjbodjaafnkbmfnjcokflbohbfdoek) - a Chrome extension that restores Twitter's bird logo.
- [**Banger.fm**](https://banger.fm) - an AI-generated music player and curated playlists.
...
- [**HIC.AF**](https://hic.af) - a digital art marketplace.
- [**NFID**](https://nfid.vercel.app) - an NFT designed to hold personal identity information.
- [**Artfolio**](https://niftyfolio.vercel.app) - an NFT portfolio and market-data dashboard.
- [**Abana Studio**](https://abana.vercel.app) - a creative lab for decentralized apps and experiments.

### 2017 - 2020

- [**Au Menu**](https://au-menu.vercel.app) - contactless digital menus for restaurants.
- [**The Atelier**](https://5e3c21d2a8851b000833c7e4--the-atelier.netlify.app) - a product studio that worked with major groups and startups on zero-to-one products.

### 2016

- [**Camomille**](https://www.instagram.com/hellocamomille) - personalized, connected home care for elderly parents, incubated by The Family.

### 2014

- [**way.js**](https://github.com/gwendall/way.js) - a simple, lightweight, persistent two-way data binding library.

### 2012

- [**TechList**](https://www.latribune.fr/blogs/tendances-web/20121203trib000734854/une-carte-de-paris-pour-reperer-les-start-up.html) - an interactive map of the French tech ecosystem and an early catalyst for the French Tech movement.
- [**Falcon.io, previously Hackerface**](https://booleanstrings.com/2013/01/28/do-not-miss-the-tool) - a people-search browser extension that reconstructed digital footprints from one data point, acquired as an $85k strategic asset.
- [**MeanBot**](https://x.com/ameanbot) - an experimental insulting chatbot exploring negative interactions before LLMs.
- [**FriendsDomains**](https://x.com/friendsdomains) - a social platform for sharing and upvoting stories behind unused domain names.

### 2011

- [**Hoodsup**](https://news.ycombinator.com/item?id=3282368) - interest-based local chatroulette with real-time video matching.

## Recent notes

- [**Vibethinking**](https://gwendall.com/notes/vibethinking) - using AI for better questions, not just faster answers.
- [**Deep work is optional**](https://gwendall.com/notes/deep-work-is-optional) - how LLMs change the cost of context switching.
- [**We are still the OS**](https://gwendall.com/notes/we-are-still-the-os) - AI as extra processing power, not a replacement for judgment.

[Website](https://gwendall.com) · [X](https://x.com/gwendall) · [Email](mailto:hi@gwendall.com)
